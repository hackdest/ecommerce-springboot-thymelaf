...
public class ProductController {
    ...
    @GetMapping("/Kho")
    public String kho(Model model, Principal principal) {
        if (principal == null) {
            return "redirect:/login";
        }
        List<ProductDto> products = productService.allProduct();
    ...
    @GetMapping("/Kho/{pageNo}")
    public String allKhos(@PathVariable("pageNo") int pageNo, Model model, Principal principal) {
        if (principal == null) {
            return "redirect:/login";
        }
